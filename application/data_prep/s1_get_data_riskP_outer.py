...
path_data = f"data/s2_filter_trial/riskyprice_filter_trial.csv"
path_subinfo = f"data/s3_subjinfo/riskyprice_filter_trial_subjinfo.csv"
...
col_norm_outer = ['a_money', 'a_prob_win', 'b_money', 'b_prob_win']
...
for idx_subj in range(n_subj):
    ...
    tmp = df_subj[["money", "prob", "response"]].values
