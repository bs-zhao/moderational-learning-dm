...
axes[0].scatter(
    x, y,
    c=L, cmap="viridis",
    alpha=scatter_alpha, s=scatter_s, linewidths=0,
)
axes[0].set_title("Grouped by True Label", fontsize=title_size)
axes[0].set_xlabel("PC1", fontsize=axis_label_size)
axes[0].set_ylabel("PC2", fontsize=axis_label_size)
...
axes[1].set_title("Grouped by K-means Clustering", fontsize=title_size)
axes[1].set_xlabel("PC1", fontsize=axis_label_size)
axes[1].set_ylabel("PC2", fontsize=axis_label_size)
